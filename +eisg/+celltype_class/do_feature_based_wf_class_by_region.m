function [celltype_labels, full_feature_mat] = do_feature_based_wf_class_by_region(...
  unit_wf_features, feature_labels, regional_feature_inds, num_features, p2v_inds, n_cluster_range, use_pca)
...
for i = 1:numel(regional_feature_inds)
  regional_labels = fcat.from( feature_labels( regional_feature_inds{i}, : ), getcats(feature_labels) );
  ...
  regional_features = unit_wf_features( regional_feature_inds{i} );
