...
% Iterate through each specified unit subset
for i = 1:numel(subset_feature_inds)
  ...
  % The function below classifies input feature_mat separately for all
  % cluster numbers in n_cluster_range, then selects the cluster number
  % which generates the least AIC value
  [regional_unit_celltypes, regional_celltype_labels] = ...
      eisg.celltype_class.do_xiang_k_means_classification(...
      feature_mat, classification_labels, p2v_vec, n_cluster_range, use_pca);
