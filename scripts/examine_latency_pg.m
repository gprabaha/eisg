...
% added a commented line in `linearize_sorted` to accept `maybe valid`
% units which are marked by NaN in the validity
...
toc;
%% find cells that differentiate face vs obj and then plot their latencies

% Identify the cells that significantly discriminate face vs obj, then do
% something like `apply_cell_type_labels` to update the spike labels with
% that information
